...
app.layout = html.Div(id="mainContainer", style={"display": "flex", "flex-direction": "column"}, children=[
    ...
    html.Div(className="row flex-display", children=[
        ...
        html.Div(className="eight columns", id="right-column", children=[
            # html.Div(id="info-container", className="row container-display", children=[
            #     html.Div(id="tti18",className="mini_container six columns", children=[html.H6(id="tti18Text"), html.P("2018 TTI")]),
            #     html.Div(id="tti19",className="mini_container six columns", children=[html.H6(id="tti19Text"), html.P("2019 TTI")]),
            # ]),
...
##########################################################################################
    ...
    figdc.update_yaxes(title_text="Hourly delay - hr", range=[min_d,max_d])
    figdc.update_xaxes(title_text="Hour of Day")
    ...
    fighmc = go.Figure(data=go.Heatmap(
        ...
        z=tc,
        zsmooth=False,
        zmin=np.floor(rfspd/1.5),
        zmax=rfspd,
        connectgaps=False,
        colorscale='RdYlGn'))

    fighmc.update_layout({'title': "Heatmap Cardinal"})
    ...
    figdnc.update_yaxes(title_text="Hourly delay - hr", range=[min_d, max_d])
    figdnc.update_xaxes(title_text="Hour of Day")
    ...
    fighmnc = go.Figure(data=go.Heatmap(
        ...
        z=tnc,
        zsmooth=False,
        zmin=np.floor(rfspdn/1.5),
        zmax=rfspdn,
        connectgaps=False,
        colorscale='RdYlGn'))

    fighmnc.update_layout({'title': "Heatmap Non-Cardinal"})


    return figc, fignc, figdc, figdnc, figtdc, figtdnc,fighmc, fighmnc
